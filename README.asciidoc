...
for its usability. Versions are slotted so you can have latest stable and any
number of snapshots installed at the same time (only the latest snapshot is kept
in this tree though).
--
