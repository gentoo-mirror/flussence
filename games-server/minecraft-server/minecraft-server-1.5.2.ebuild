...
# Added for 1.5.2 idiocy
pkg_nofetch() {
	einfo "${PV} has no versioned upstream URL, so you'll need to download"
	einfo "the server from the page at https://minecraft.net/download and"
	einfo "rename it to ${DISTDIR}/${P}.jar"
}
